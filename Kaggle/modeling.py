...
file_directory = r"prepared_data.parquet"
df = pd.read_parquet(file_directory)

"""Train-test split"""
# Splitting dataset into training and test sets
X_train, X_test, y_train, y_test = train_test_split(
    df.drop(columns=['satisfaction']), df['satisfaction'],
    test_size=0.2, random_state=42
)

"""Validation split"""
# Further splitting training set into training and validation sets for better model evaluation
